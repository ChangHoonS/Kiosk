...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // menu.get(2).getMenuItems().get(2).setName("Zero Cider");  세터 사용의 예
        // System.out.println(menu.get(2).getMenuItems().get(2).getName()); 세터 사용의 예 - 이전에 세터로 사이다로 바꿧기에 Zero Cider로 출력됨
